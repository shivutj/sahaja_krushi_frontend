    ...
    },
    {
      ...
      render: (_: any, record: CropReport) => (
        <div className="space-x-2">
          <a
            href={`/admin/farmer-report/${record.id}`}
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold text-green-700">Farmer Crop Reports</h2>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-100">
          <DynamicTable columns={columns} data={filtered} label={"Farmer Crop Reports"} rowKey="id" pagination={{ current: 1, total: shownCount, pageSize: shownCount || 1 }} />
          {loading && (
